  ...
  return (
    <div className="min-h-screen bg-white flex items-center justify-center p-4">
      ...
      >
        ...
        {/* Main card */}
        <div className="relative bg-white border-2 border-black rounded-2xl shadow-lg overflow-hidden w-96 transform transition-all duration-500 hover:scale-105 hover:shadow-2xl hover:-translate-y-1">
          {/* Spotlight effect */}
          <div
          ...
          <div className="px-8 py-12 relative">
            ...
            <div className="text-center mb-6 transform transition-all duration-500">
              <h2 
                className="text-4xl font-bold text-black mb-3 tracking-tight leading-tight transition-all duration-500 group-hover:tracking-wide"
                style={{ 
            ...
            {/* Email */}
            <div className="flex items-center justify-center gap-3 text-gray-600 text-sm group/info transition-all duration-500 cursor-pointer hover:gap-4">
              <Mail 
                size={16} 
              ...
              />
              <span 
                className="group-hover/info:text-black transition-all duration-300"
